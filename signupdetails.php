<?php 
    ...
    if(isset($_POST['submit'])&&($_POST['password']===$_POST['confirm_pass'])){
        ...
        //echo"DONE";
        $query="INSERT INTO users(user_name,email,confirm_pass,first_name,last_name) VALUES('$user_name','$email','$hash_pass','$first_name','$last_name')";
        mysqli_query($db,$query);
        //$_SESSION['msg']="Done sucessfully";
        header('location: login.php');//redirect to index page after insertion
